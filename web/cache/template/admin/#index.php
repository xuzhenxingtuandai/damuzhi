...
<li style="display:none"><a href="http://www.cmseasy.cn" target="_blank">官方网站</a> | <a href="http://www.cmseasy.cn/service_1.html" target="_blank">授权</a> | <a href="http://www.cmseasy.org" target="_blank">支持论坛</a> | <a href="http://chm.cmseasy.cn/" target="_blank">帮助？</a></li>
</ul>
</div>
</div>
...
<div style="display:none;"><a href="<?php echo url::create('config/remove');?>" class="on">更新缓存</a></div>
</div>
</div>
