...
<title>选择图片 - Powered by CmsEasy</title>
...
var picview="index.php?case=file&act=ps&maxselect=<?php echo front::get('maxselect');?>";
...
function piclistshow(filename,inputnameID,getbyid,iswidth){
var filenames = filename.split('|');
var src_tex='';
...
parent.document.getElementById(getbyid).innerHTML = parent.document.getElementById(getbyid).innerHTML+'<div id="pics'+j+'_up" style="clear:both;"><span id="'+inputnameID+j+'_preview"><img width="150" style="width:150px;" src="'+filenames[i]+'" border="0" /></span><div class="blank10"></div><input id="'+inputnameID+j+'" value="'+filenames[i]+'" class="input" name="'+inputnameID+j+'" style="float:left;" /><input style="float:left;" id="'+inputnameID+j+'_del" onclick="pics_delete(\''+j+'\',\''+inputnameID+'\');" value="" type="button" name="delbutton" class="a_del" /></div>';
...
<div id="tabcontentdiv1" class="displaytrue"><iframe name="upfilewindow" class="upfilewindow" src="index.php?case=file&act=upfile" width="100%" height="405" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
        <div id="tabcontentdiv2" class="displaynone"><iframe name="netpic" id="netpic" class="upfilewindow" src="#" width="100%" height="405" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
