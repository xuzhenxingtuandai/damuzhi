...
<title>图片上传 - Powered by CmsEasy</title>
...
var xiSwfUrlStr = "js/upimg/playerProductInstall.swf";
            ...
            swfobject.embedSWF("js/upimg/mpupload.swf", "flashContent", "570", "360", swfVersionStr, xiSwfUrlStr, flashvars, params, attributes);
 </script>
...
<body class="bodyflow">
<span onclick="$('#single').css('display','block');$('#muti').css('display','none');"" style="cursor:pointer;background:#4A9400;padding:0px 5px;color:white;">单文件上传</span> <span onclick="$('#single').css('display','none');$('#muti').css('display','block');" style="cursor:pointer;background:#4A9400;padding:0px 5px;color:white;">多文件上传</span>
...
<div id="downbotton">
  <div id="subbotton">
    <table border="0" width="100%">
      <tr id="bottonsubmit">
        <td id="center"><table border="0" style="margin: 0 auto;">
            <tr >
