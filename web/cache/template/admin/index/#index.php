...
.i_box {
  ...
  height:520px;
  padding:15px;
  background:url(<?php echo $skin_path;?>/images/i_box/i_bg.jpg);
...
<li class="i_table_b"  style="display:none;">集团网站：<?php foreach(getwebsite() as $d) { ?>
<a href="<?php echo $d['addr'];?>" target="_blank"><span><?php echo $d['name'];?></span></a>&nbsp;
<?php } ?></li>
<li  style="display:none;"><span style="float:left;">系统版本：CmsEasy <span id="__version"><?php echo _VERSION;?></span> </span>
...
<div id="i_info" style="display:none;">
