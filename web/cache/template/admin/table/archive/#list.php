...
foreach($data as $d) { ?>
            <tr>
                ...
                <td align="center"><?php echo form::input("listorder[$d[$primary_key]]",$d['listorder'],'class="input_c"');?></td>

                <td align="center"><?php echo cut($d['aid']);?></td>
                <td align="center"><span class="hotspot" onmouseover="tooltip.show('查看内容所属栏目');" onmouseout="tooltip.hide();"><a href="<?php echo url("archive/list/catid/".$d['catid'],false);?>" target="_blank"><?php echo catname($d['catid']);?></a></span></td>
