...
<td align="center" ><span class="hotspot" onmouseover="tooltip.show('填写排序号，<br />数字越大，排序越靠前！');" onmouseout="tooltip.hide();"><?php echo form::input("listorder[$d[$primary_key]]",$d['listorder'],'class="input_c"');?></span></td>
<td align="center" >
<?php echo $d['catid'];?>
</td>
<td align="left" style="padding-left:10px;"><span class="hotspot" onmouseover="tooltip.show('点击编辑栏目设置，<br />可方便的修改栏目的各项设置');" onmouseout="tooltip.hide();"><a href="<?php echo modify("/act/edit/table/$table/id/$d[$primary_key]");?>"><?php echo $d['catname'];?></a></span>
</td>
...
foreach($data1 as $d1) { ?>
            ...
            <tr>
<td align="center" ><input onclick="c_chang(this)" type="checkbox" value="<?php echo $d1[$primary_key];?>" name="select[]"> </td>
<td align="center" ><span class="hotspot" onmouseover="tooltip.show('填写排序号，<br />数字越大，排序越靠前！');" onmouseout="tooltip.hide();"><?php echo form::input("listorder[$d1[$primary_key]]",$d1['listorder'],'class="input_c"');?></span></td>
<td align="center" >
    <?php echo $d1['catid'];?>            </td>
<td align="left" style="padding-left:10px;">
   <span class="hotspot" onmouseover="tooltip.show('点击编辑栏目设置，<br />可方便的修改栏目的各项设置');" onmouseout="tooltip.hide();"><a href="<?php echo modify("/act/edit/table/$table/id/$d1[$primary_key]");?>"><?php echo $d1['catname'];?></a></span>
             
</td>

<td align="center" >
    <span class="hotspot" onmouseover="tooltip.show('点击查看前台页面效果，<br />可直观查看栏目的显示样式');" onmouseout="tooltip.hide();"><a href="<?php echo url("archive/list/catid/$d1[$primary_key]",false);?>" target="_blank"><?php echo $d1['htmldir'];?></a></span>            </td>

<td align="center" >
    <?php echo helper::yes($d1['isnav'],false);?>            </td>
