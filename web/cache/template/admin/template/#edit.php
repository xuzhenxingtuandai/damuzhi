            ...
            <tbody>
                <tr class="s_out">
                    ...
                    <td  width="31%" style="padding-left:10px;">
                        <input type="text" name="<?php echo $tpl;?>_name" class="input_d" value="<?php echo @help::tpl_name($tpl);?>">
                    </td>
                    <td width="31%" style="padding-left:10px;">
                        <input type="text" name="<?php echo $tpl;?>_note" class="input_d" value="<?php echo @help::tpl_note($tpl);?>">
                    </td>
                </tr>
            </tbody>
        </table>
