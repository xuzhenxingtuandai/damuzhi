...
<div class="page"><?php echo $link_str;?></div><div class="blank10"></div>
<thead>
        <tr class="th">
...
<tbody>
      ...
      <tr class="s_out">
          <td align="left" style="padding-left:10px;"><?php echo $_tp;?></td>
           ...
           <input type="text" name="<?php echo $tpl;?>_name" class="input_d" value="<?php echo @help::$var['template_note'][$tpl.'_name'];?>">
           </td>
           <td align="left" style="padding-left:10px;">
           <input type="text" name="<?php echo $tpl;?>_note" class="input_d" value="<?php echo @help::$var['template_note'][$tpl.'_note'];?>">
           </td>
        </tr>
       <?php } ?>
