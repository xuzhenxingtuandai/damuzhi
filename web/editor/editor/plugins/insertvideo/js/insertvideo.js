...
function Ok() {
    ...
    sMusicHtml = '<embed src="' + str + '/editor/plugins/insertvideo/player/jwplayer.swf" width="' + width + '" height="' + height + '" bgcolor="#ffffff" allowscriptaccess="always" allowfullscreen="true" flashvars="' + flashvars + '"/>';
