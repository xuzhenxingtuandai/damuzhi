...
<tr class="th">
				...
				<th align="center" width="40">关联</th>
            </tr>
            </thead>
        <tbody>
{user_cb_data($data,$table)}
            ...
            <tr>
				...
				<span class="hotspot" onmouseover="tooltip.show('查看表单关联内容页面！');" onmouseout="tooltip.hide();"><a href="index.php?case=archive&act=show&aid={get(aid)}" target="_blank" class="a_view">{getArchiveTitle($data[aid])}</a></span></center>{else}无
				{/if}</td>
            </tr>
