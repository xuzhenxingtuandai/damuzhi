...
<a href="http://{$base_url}/index.php?case=sms&act=manage&admin_dir={get('admin_dir')}&site=default" class="btn_d">设置</a>
...
<input type="submit" name="submit" id="submit" value="充值" class="btn_d" />
