...
<div id="con_one_1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
        ...
        <tr>
            ...
            <td width="1%">&nbsp;</td>
            <td width="70%"><input type="text" name="adddate" id="adddate" value="<?php echo date('Y-m-d H:i:s'); ?>" class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布时间，可自定义，格式：2010-08-08 08:08:08！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="1%">&nbsp;</td>
            <td width="70%"><input type="text" name="author" id="author" value="<?php echo $user['username'] ?>"   class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布作者名，可自定义！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
            </td>
        </tr>
        <tr>
