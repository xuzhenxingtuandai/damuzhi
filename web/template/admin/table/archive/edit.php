...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('catid',$form,$field,$data)}
<span class="hotspot" onmouseover="tooltip.show('选择内容所在栏目，如果栏目有子级栏目，请选择子级栏目！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('toppost',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('title',$form,$field,$data,'class="input"')}
...
<div id="divStatus"></div>
  ...
  <tr>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('introduce',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('tag',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="adddate" id="adddate" value="{$data[adddate]}" class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布时间，可自定义，格式：2010-08-08 08:08:08！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
		</td>
    </tr>
		<tr>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="author" id="author" value="<?php echo $data['author'] ?>"   class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布作者名，可自定义！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
		</td>
    </tr>
    <tr>
        <td width="19%" align="right">来源</td>
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('attr3',$form,$field,$data)}<span class="hotspot" onmouseover="tooltip.show('内容发布来源，可自定义，默认为本站网址！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span>
		</td>
    </tr>
	<tr>
        <td width="19%" align="right">审核</td>
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('checked',$form,$field,$data)}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="table2">
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('mtitle',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('keyword',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('description',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('ishtml',$form,$field,$data)}
...
<a title="选择文件" onclick="javascript:windowsdig('选择文件','iframe:index.php?case=file&act=updialog&fileinputid=pics&getbyid=pvpics&maxselect=99&checkfrom=piclistshow','900px','480px','iframe')" href="#body"><p><img src="images/add_pic.gif" /></p></a><span class="hotspot" onmouseover="tooltip.show('当内容页模板选择：<br /> [ 图片内容页 - archive/show_pic.html ] <br />用于图片幻灯显示效果展示！');" onmouseout="tooltip.hide();">
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%" id="content-recommend">{form::getform('attr1',$form,$field,$data)}
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('linkto',$form,$field,$data)}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="table4">
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('thumb',$form,$field,$data)}
...
<?php echo form::select('spid',
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('pcolor',$form,$field,$data)}
