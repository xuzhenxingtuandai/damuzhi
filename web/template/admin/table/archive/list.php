    ...
    <table border="0" cellspacing="0" cellpadding="0" name="table1" id="table1" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center"><span class="hotspot" onmouseover="tooltip.show('查看内容所属栏目');" onmouseout="tooltip.hide();"><a href="<?php echo url("archive/list/catid/".$d[catid],false);?>" target="_blank">{catname($d['catid'])}</a></span></td>
