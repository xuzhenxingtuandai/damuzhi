...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('parentid',$form,$field,$data)}<span class="hotspot" onmouseover="tooltip.show('如果为一级栏目，不需选择！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>

<tr>
<td width="19%" align="right">栏目名称</td>
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('catname',$form,$field,$data,'class="input"')}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('isnav',$form,$field,$data)}  <span class="hotspot" onmouseover="tooltip.show('如果是一级目录，可选择是否在导航中显示栏目名称和链接！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>

<tr>
<td width="19%" align="right">在手机版中显示</td>
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('ismobilenav',$form,$field,$data)}  <span class="hotspot" onmouseover="tooltip.show('如果是一级目录，可选择是否在导航中显示栏目名称和链接！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('isshow',$form,$field,$data)}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('ispages',$form,$field,$data)}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('attr3',$form,$field,$data,'class="input_c"')}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('includecatarchives',$form,$field,$data)}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('linkto',$form,$field,$data,'class="input"')}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::getform('image',$form,$field,$data)}
...
<td width="1%">&nbsp;</td>
<td width="70%">{form::input('thumb_width',$data['thumb_width'],'size="5" class="input_c"')} px × {form::input('thumb_height',$data['thumb_height'],'size="5" class="input_c"')} px
