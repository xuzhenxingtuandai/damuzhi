...
<span class="hotspot" onmouseover="tooltip.show('点击查看!');" onmouseout="tooltip.hide();"><a href="<?php echo url("special/show/spid/$spid", false); ?>" class="a_view"></a></span>
...
<span class="hotspot" onmouseover="tooltip.show('确定要删除吗？');" onmouseout="tooltip.hide();"><a onclick="javascript: return confirm('确实要删除吗?');" href="<?php echo modify("/act/delete/table/special/id/$spid"); ?>" class="a_del"></a></span>
