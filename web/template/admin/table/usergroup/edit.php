...
.row{
  ...
  color:white;
  font-weight:normal;
  background:url({$skin_path}/images/th_line.gif) right center no-repeat;
  }
                  ...
                  <tr>
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          ...
                          模板结构</td>
                          <td class="unit"><input class="template template_manage" type="checkbox" name="powerlist[template_edit]" {getchecked($data['powerlist'],'template_edit')} value="1" />
                          模板编辑</td>
                        </tr>
                    </table></td>
                  </tr>
